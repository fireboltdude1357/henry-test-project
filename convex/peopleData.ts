...
export const addTripIdea = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const updated = [
      ...(peopleDataDoc.tripIdeas as unknown as {
        title: string;
        links: string[];
        notes: string;
        photos: string[];
    ...
    await ctx.db.patch(peopleDataDoc._id, { tripIdeas: updated });
    return peopleDataDoc._id;
  },
});

export const updateTripIdea = mutation({
  args: {
    personId: v.id("people"),
    index: v.number(),
  ...
  handler: async (ctx, args) => {
    ...
    const ideas = peopleDataDoc.tripIdeas as unknown as {
      title: string;
      links: string[];
      notes: string;
      photos: string[];
...
export const removeTripIdea = mutation({
